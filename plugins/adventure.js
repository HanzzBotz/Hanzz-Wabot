...
`.trim()
            ...
            } else conn.sendButton(m.chat, `Anda sudah berpetualang dan kelelahan, silahkan coba *${timers}* lagi`, wm, '🎒Inventory', 'inv', m)
        } else conn.send2Button(m.chat, 'Minimal 80 health♥️ untuk bisa berpetualang, beli nyawa dulu dengan ketik *' + usedPrefix + 'shop buy potion <jumlah>*\ndan ketik *' + usedPrefix + 'use potion <jumlah>*', wm, 'Heal', '.heal', 'Buy Potion', '.shop buy potion 1', m)
    } catch (e) {
        console.log(e)
