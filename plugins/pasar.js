                  ...
                  case 'lobster':
                    ...
                    case 'hiu':
                        if (global.DATABASE.data.users[m.sender].hiu >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Hiu, Dan Anda Mendapatkan ${Shiu * count} Money `, m)
                    ...
                    case 'gurita':
                        if (global.DATABASE.data.users[m.sender].gurita >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Gurita, Dan Anda Mendapatkan ${Sgurita * count} Money `, m)
                    ...
                    case 'dory':
                        if (global.DATABASE.data.users[m.sender].dory >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} dory, Dan Anda Mendapatkan ${Sdory * count} Money `, m)
                    ...
                    case 'buntal':
                        if (global.DATABASE.data.users[m.sender].buntal >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Buntal, Dan Anda Mendapatkan ${Sbuntal * count} Money `, m)
                    ...
                    case 'orca':
                        if (global.DATABASE.data.users[m.sender].orca >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Orca, Dan Anda Mendapatkan ${Sorca * count} Money `, m)
                    ...
                    case 'lumba':
                        if (global.DATABASE.data.users[m.sender].lumba >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Lumba, Dan Anda Mendapatkan ${Slumba * count} Money `, m)
                    ...
                    case 'harimau':
                        if (global.DATABASE.data.users[m.sender].harimau >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Harimau, Dan Anda Mendapatkan ${Sharimau * count} Money `, m)
                    ...
                    case 'gajah':
                        if (global.DATABASE.data.users[m.sender].gajah >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Gajah, Dan Anda Mendapatkan ${Sgajah * count} Money `, m)
                    ...
                    case 'kambing':
                        if (global.DATABASE.data.users[m.sender].kambing >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Kambing, Dan Anda Mendapatkan ${Skambing * count} Money `, m)
                    ...
                    case 'panda':
                        if (global.DATABASE.data.users[m.sender].panda >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Panda, Dan Anda Mendapatkan ${Spanda * count} Money `, m)
                        } else conn.reply(m.chat, `Panda Anda Tidak Cukup `, m)
                        break                        
                     case 'buaya':
                        if (global.DATABASE.data.users[m.sender].buaya >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Buaya, Dan Anda Mendapatkan ${Sbuaya * count} Money `, m)
                    ...
                    case 'kerbau':
                        if (global.DATABASE.data.users[m.sender].kerbau >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Kerbau, Dan Anda Mendapatkan ${Skerbau * count} Money `, m)
                    ...
                    case 'sapi':
                        if (global.DATABASE.data.users[m.sender].sapi >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Sapi, Dan Anda Mendapatkan ${Ssapi * count} Money `, m)
                    ...
                    case 'monyet':
                        if (global.DATABASE.data.users[m.sender].monyet >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Monyet, Dan Anda Mendapatkan ${Smonyet * count} Money `, m)
                    ...
                    case 'babihutan':
                        if (global.DATABASE.data.users[m.sender].babihutan >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Babi Hutan, Dan Anda Mendapatkan ${Sbabihutan * count} Money `, m)
                        } else conn.reply(m.chat, `Babi Hutan Anda Tidak Cukup `, m)
                        break                   
                    case 'babi':
                        if (global.DATABASE.data.users[m.sender].babi >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Babi, Dan Anda Mendapatkan ${Sbabi * count} Money `, m)
                    ...
                    case 'ayam':
                        if (global.DATABASE.data.users[m.sender].ayam >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Ayam, Dan Anda Mendapatkan ${Sayam * count} Money `, m)
            ...
            switch (type) { 
                  ...
                  case 'lobster':
                    ...
                    case 'kambing':
                        ...
                        break      
                    case 'kelinci':
                        if (global.DATABASE.data.users[m.sender].kelinci >= count * 1) {
                            global.DATABASE.data.users[m.sender].kelinci -= count * 1
                            global.DATABASE.data.users[m.sender].money += Spanda * count
                            conn.reply(m.chat, `Sukses Menjual ${count} Kelinci, Dan Anda Mendapatkan ${Spanda * count} Money `, m)
                        } else conn.reply(m.chat, `Kelinci Anda Tidak Cukup `, m)
                        break                        
                     case 'buaya':
                        if (global.DATABASE.data.users[m.sender].buaya >= count * 1) {
                            global.DATABASE.data.users[m.sender].buaya -= count * 1
