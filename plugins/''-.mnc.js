...
let handler = async (m, { conn }) => {
	let wm = global.wm
	let img = 'https://telegra.ph/file/f48f7cfe6144ad285f6c6.jpg'
...
let randomaku11 = `${Math.floor(Math.random() * 1)}`
let randomaku12 = `${Math.floor(Math.random() * 1)}`
.trim()
...
setTimeout(() => {
                     conn.send2ButtonImg(m.chat, img, hsl, wm, 'Pasar', '.sell', 'Kolam', '.kolam', m)
                     }, 20000) 
