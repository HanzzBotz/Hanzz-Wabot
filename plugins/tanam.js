...
let handler = async (m, { conn }) => {
    ...
    let buttons = [
{buttonId: 'id1', buttonText: {displayText: '!sawah'}, type: 1}, 
]
const buttonMessage = {
...
©Hanzz Botz
`
global.DATABASE.data.users[m.sender].jagung += rbrb1
global.DATABASE.data.users[m.sender].cabai += rbrb2
global.DATABASE.data.users[m.sender].wortel += rbrb3
global.DATABASE.data.users[m.sender].tomat += rbrb4
global.DATABASE.data.users[m.sender].kentang += rbrb5
global.DATABASE.data.users[m.sender].padi += rbrb6
