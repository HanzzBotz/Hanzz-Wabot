...
╰───
`.trim()
await conn.sendButtonLoc(m.chat, await (await fetch(`https://www6.flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=sketch-name&doScale=true&scaleWidth=800&scaleHeight=500&fontsize=100&fillTextType=1&fillTextPattern=Warning!&text=Panduan Dan Rules`)).buffer(), ext.trim(), 'Hanzz Botz By Hanzz-kun', '👤 NOMER OWNER', '.owner',m)
