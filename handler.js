      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          if (!isPrems && plugin.limit && global.DATABASE._data.users[m.sender].limit < plugin.limit * 1) {
            this.send2Button(m.chat, `Limit/Tiket Anda Habis, Silahkan Beli Dengan Klik Button Dibawah, Atau Jadilah User Premium Agar Limit Anda Unlimited, Jika Berminat Klik Button Dibawah`, wm, 'Buy All', '.buyall', 'Premium', '.premium', m)
